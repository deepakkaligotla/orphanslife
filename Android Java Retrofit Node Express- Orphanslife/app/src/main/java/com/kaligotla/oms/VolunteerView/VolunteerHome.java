package com.kaligotla.oms.VolunteerView;
...
public class VolunteerHome extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity( new Intent( VolunteerHome.this, Donate.class ) );
        } else if (item.getTitle().equals( "Adopt" )) {
            startActivity( new Intent( VolunteerHome.this, Adopt.class ) );
            ...
            startActivity( new Intent( VolunteerHome.this, MainActivity.class ) );
