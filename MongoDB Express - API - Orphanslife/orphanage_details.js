...
router.get('/activities', [auth], (request, response) => {
    const statement = `SELECT * FROM orphanage_activities JOIN orphanage ON orphanage_activities.orphanage_id=orphanage.orphanage_id`
