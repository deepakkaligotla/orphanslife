  ...
  routeHomePage() {
    if (this.state.loggedInUser.role_id != undefined) {
      if (this.state.loggedInUser.role_id == 1) {
        RootNavigation.navigate('VolunteerTab', { loggedInDetails: this.state.loggedInUser })
      }
      if (this.state.loggedInUser.role_id == 2) {
        RootNavigation.navigate('GuardianTab', { loggedInDetails: this.state.loggedInUser })
      }
      if (this.state.loggedInUser.role_id == 3) {
        RootNavigation.navigate('AdminTab', { loggedInDetails: this.state.loggedInUser })
      }
    } else if (this.state.loggedInUser.sponsor_name != undefined) {
      RootNavigation.navigate('SponsorTab', { loggedInDetails: this.state.loggedInUser })
    }
  }
};
