package com.kaligotla.orphanslife.ui.view.admin_home
...
class AdminHome : AppCompatActivity() {
    ...
    var loggedInAdminDetails: Admin = Admin()
    var success: Int = 0
    var failed: Int = 0
    var new_req: Int = 0
    var approved: Int = 0
    ...
    override fun onResume() {
        ...
        binding.bottomNavigation.setOnItemSelectedListener{item->
            when (item.itemId) {
                R.id.nav_home -> {
                    Toast.makeText(this@AdminHome, "Nav Home", Toast.LENGTH_SHORT)
                    intent = Intent(this, AdminHome::class.java)
                    startActivity(intent)
                    true
                }
                R.id.nav_settings -> {
                    Toast.makeText(this@AdminHome, "Nav Settings", Toast.LENGTH_SHORT)
        ...
        binding.bottomNavigation.setOnItemReselectedListener {item->
            when (item.itemId) {
                R.id.nav_home -> {
                    Toast.makeText(this@AdminHome, "Already in Nav Home", Toast.LENGTH_SHORT)
                    true
                }
                R.id.nav_settings -> {
                    Toast.makeText(this@AdminHome, "Already in Nav Settings", Toast.LENGTH_SHORT)
                    true
                }
                else -> false
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.settings -> {
                Toast.makeText(this@AdminHome, "Settings", Toast.LENGTH_SHORT)
                intent = Intent(this, AdminAccountSettings::class.java)
                startActivity(intent)
                return true
            }
